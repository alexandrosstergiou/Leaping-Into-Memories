...
# Coefficient for reliance on deep features from the verifier network.
_C.COEF.VERIFIER_FEAT = 0.05

# Coefficient for reliance on prompt-based features.
_C.COEF.PROMPT = 0.01

 # Coefficient for enforcing a PSNR-based difference between the start and end  frames of the generated clip.
_C.COEF.PSNR_VID=5
 
 # Coefficient for enforcing a PSNR-based similarity between adjacent frames in the generated clip
_C.COEF.PSNR_CROSS_FRAME=4

# Coefficient for the first normalisation layer of the verifier.  The rest of the normalisation layers will be multipled by coeffients that will be exponentially decreasing.
_C.COEF.VERIFIER_FIRST_NORM=1

# Coeffient  for the L1 Total Variation 
_C.COEF.TV_L1=1

# Coeffient  for the L2 Total Variation 
_C.AUG.TV_L2=1

# Coeffient  for the L2 Total Variation 
_C.AUG.L2=1

# Coefficient for the final loss
_C.AUG.LOSS_MULTIPLIER=1
