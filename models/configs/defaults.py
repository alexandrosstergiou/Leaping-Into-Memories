...
# number of heads per blocks.
_C.SWIN.NUM_HEADS = [3, 6, 12, 24]

# space-time window size.
_C.SWIN.WINDOW_SIZE = (8,7,7)
...
# setting the scale for QK.
_C.SWIN.QK_SCALE = None

# Droprate.
_C.SWIN.DROP  =  0.

# Drop rate for attention.
_C.SWIN.ATTN_DROP_RATE = 0.

# Droppath rate.
_C.SWIN.DROP_PATH_RATE = 0.2

# Use patch normalisation.
_C.SWIN.PATCH_NORM = True

# Cfg for the classification head.
_C.SWIN.CLS_HEAD = CfgNode()

# Classification head type.
_C.SWIN.CLS_HEAD.TYPE = 'I3DHead'

# Feature dim.
_C.SWIN.CLS_HEAD.IN_CHANNELS = 768

# Number of classes for the classification head.
_C.SWIN.CLS_HEAD.NUM_CLASSES = 400

# Type for aggregating spatial features.
_C.SWIN.CLS_HEAD.SPATIAL_TYPE = 'avg'

# Drop ratio for classification head.
_C.SWIN.CLS_HEAD.DROP_RATIO = 0.5
